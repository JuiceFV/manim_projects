...
class FirstVideoIntro:
    ...
    def play(self):
        play_and_wait(Write(self.wrong_query), scene=self._scene, play_time=1, wait_time=0)
        self.fix_layout()
        self.fix_brand()
        self.fix_space()
        self.fix_typos()
...
class SecondVideoIntro:
    ...
    def write_query(self):
        ...
        play_and_wait(Write(self.query),
                      ...
                      play_time=1,
                      wait_time=0)
        play_and_wait(self.query.animate.scale(0.3).to_edge(UL + [0.01, 4, 0]),
                      scene=self._scene,
                      play_time=1,
                      wait_time=0)
    ...
    def pick_category(self):
        self.res_category.scale(0.5).next_to(self.classified_categories, RIGHT * 2)
